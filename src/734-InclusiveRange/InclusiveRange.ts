...
import { NumberRangeTuple } from '../8640-NumberRange/NumberRange'

type InclusiveRange<Lower extends number, Higher extends number> = Equal<Lower,Higher> extends true ? [Lower] : NewGreaterThan<Higher,Lower> extends true ? NumberRangeTuple<Lower,Higher> : []
...
type TestRange = InclusiveRange<0, 10>
type TestRange2 = InclusiveRange<1, 200>